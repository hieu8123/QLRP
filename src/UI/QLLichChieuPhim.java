...
//    }
    ...
    public void showSuatChieu(List<SuatChieu> scs){
        //DefaultTableModel defaultTableModel;
    ...
    private void initComponents() {
        ...
        day_NgayChieu.setBounds(130, 330, 290, 22);
    ...
    private void button_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_themActionPerformed
        try {
            ...
            String date = new SimpleDateFormat("dd-MM-yyyy").format(day_NgayChieu.getDate());
