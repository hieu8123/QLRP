...
public class Thanh_Toan extends javax.swing.JFrame {
        ...
        if (GheDaDat == 0){
            ...
            if (DatVeThanhCong){
                ...
                try {
                    ...
                    con.commit();
                    for(int i = 0; i<DatVe.MaGhe.size(); i++){
                    InVe(DatVe.tenghe.substring(3*i + 1, 3*i + 3), MaSC, MaGheSQL);
                }
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (DiemSuDung <= DiemHienCo) {
                if (temp_value_dtl <= DiemSuDung) { //dsd = 2000, temp = 1000
                    ...
                    giamgiaDTL += DiemSuDung;
                    Lable_giamgia_ht.setText(String.valueOf(giamgiaDTL));
    ...
    void InVe(String Ghe, String MaSc, String MaGhe) {
        ...
        try {
            Connection con = JDBCConnection.getJDBCConnection();
            String dir = "src\\report\\ticket.jrxml";
